			...
			<div class="col-md-12">
				<div class="x_panel">
					...
					<?php if($message){
						...
						<form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/expensetype/editexpensetype");?>"  id="AddForm" name="AddForm">
							<input type="hidden" value="<?php echo $expensetype[0]->exp_id; ?>" name="exp_id" />

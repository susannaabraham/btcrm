            ...
            <div class="col-md-12">
              <div class="x_panel">
				...
				<?php if($message){
                  ...
                  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/projects/saveproject");?>"  id="AddForm" name="AddForm">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Project Name" name="name"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>
					...
					<div class="item form-group">
					 ...
					 <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Project Start Date" name="startdate" autocomplete="off"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>
				  ...
				  <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Contact Person" name="contact_person"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>	
					...
					<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Contact Number" name="contact_number"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>	
					...
					<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Email Address" name="email"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>	

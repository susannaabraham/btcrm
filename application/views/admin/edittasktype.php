			...
			<div class="col-md-12">
				<div class="x_panel">
					...
					<?php if($message){
						...
						<form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/tasktype/edittasktype");?>"  id="AddForm" name="AddForm">
							<input type="hidden" value="<?php echo $tasktype[0]->id; ?>" name="id" />
							
							
							
                    <div class="item form-group">
                      <label for="name" class="control-label col-md-3 col-sm-3 col-xs-12">Task Type Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Task Type Name" name="name"   class="form-control col-md-7 col-xs-12" value="<?php echo $tasktype[0]->name; ?>" >
                      </div>
                    </div>

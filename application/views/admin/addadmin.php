            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
               <!-- <div class="x_title">
                ...
                <div class="x_content">
                  <p style="text-align:right;"><a href="<?php echo base_url("admin/admin/newadmin"); ?>"  class="btn btn-primary"><i class="fa fa-plus"></i> Add New User</a></p>
                  <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    ...
                    <tbody>
						<?php
						for($i=0;$i<count($cgrp);$i++){
						?>
						<TR id="dat_<?php echo $cgrp[$i]->id; ?>" role="row" class="odd">
							<TD><?php echo $cgrp[$i]->uname; ?></TD>
							<TD><?php $mode= $cgrp[$i]->mode;
							$str="select groupname from user_groups where groupid=$mode";
							$query=$this->db->query($str);
							$group=$query->result();
							echo $group[0]->groupname;?></TD>
							
							<TD>
								<a class="btn btn-default " href="<?php echo base_url('/admin/admin/editadmin')."?keyword=".$cgrp[$i]->id; ?>"><i class="fa fa-edit"></i></a>
								<a class="btn btn-default " href="javascript:void(0);" onClick="deleteAdmin('<?php echo $cgrp[$i]->id; ?>');"><i class="fa fa-remove"></i></a>
							</TD>
						</TR>
						<?php
							}

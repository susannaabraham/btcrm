			...
			<div class="col-md-12">
				<div class="x_panel">
					...
					<?php if($message){
						...
						<form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/expensesubtype/editexpensesubtype");?>"  id="AddForm" name="AddForm">
							<input type="hidden" value="<?php echo $expensesubtype[0]->exp_subid; ?>" name="exp_subid" />
							
							
							
                    <div class="item form-group">
                      <label for="name" class="control-label col-md-3 col-sm-3 col-xs-12">Expense Sub Type Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Expense Sub Type Name" name="exp_subname"  class="form-control col-md-7 col-xs-12" value="<?php echo $expensesubtype[0]->exp_subname; ?>" >
                      </div>
                    </div>

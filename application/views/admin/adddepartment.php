            ...
            <div class="col-md-12">
              <div class="x_panel">
				...
				<?php if($message){
                  ...
                  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/department/savedepartment");?>"  id="AddForm" name="AddForm">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Department Name" name="name"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>

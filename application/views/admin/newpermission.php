            ...
            <div class="col-md-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form novalidate="" name="frmdid" id="frmdid" class="form-horizontal form-label-left" action="<?php echo base_url("/admin/permission/savepermission"); ?>" method="post">
					...
					<?php
						...
						<!--label class="col-md-12 col-sm-12 col-xs-12"><u> <?php echo $cgrp1[$i]->modulename; ?></u></label-->
							...
							<input type="checkbox"  value="<?php echo $res[$j]->permission; ?>" name="permissions[]" />

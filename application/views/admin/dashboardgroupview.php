...
$(function () {
	...
	$("#flotcontainer1").html("");
	 var data = [
		...
		?>
        {label: "<?php echo $outboundcalldispo[$i]->disposition ?>", data:<?php echo $outboundcalldispo[$i]->count ?>},
       <?php
			}
	   ?>
		];
...
<script>
  ...
  function startamBarge(){
    ...
    $.ajax({ url: "<?php echo base_url("/admin/dashboard/amBarge"); ?>",data:{"u":$u,"a":$a} ,success: function(data) {
	...
	(function getdata() {
		   setTimeout(function() {
			   $.ajax({ url: "<?php echo base_url("/admin/dashboard/poll"); ?>",data:"" ,success: function(data) {
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="page-title">
			...
			$sql ="SELECT * FROM `call_groups` where `gid`='".$id."'";
			$query=$this->db->query($sql);
			foreach ($query->result() as $row) {
								$name = $row->name; 
								echo strtoupper($name);} ?> DASHBOARD 
				
			<?php } else {

			
			if(count($myArray)>1) { 
			$sql ="SELECT * FROM `call_groups` where `gid`='".$myArray[0]."'";
			$query=$this->db->query($sql);
			foreach ($query->result() as $row) {
			$name = $row->name;
			echo strtoupper($name);?> DASHBOARD 
			...
			$sql ="SELECT * FROM `call_groups` where `gid`='".$groups."'";
			$query=$this->db->query($sql);
			foreach ($query->result() as $row) {
			$name = $row->name; 
			echo strtoupper($name); } ?> DASHBOARD
...
<div class="row">
					<form id="ShowForm" name="RptForm" class="form-horizontal"  role="form" action="<?php echo base_url("/admin/dashboard/custom_dashboard"); ?>?<?php echo http_build_query($_GET, '', "&");?>">
						...
						<div class="col-md-8 " >
		<input type="text" placeholder="Select Date Range" id="single_cal1" name="single_cal1" class="form-control">
						</div>
        ...
        <div class="row tile_count">
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count" style="width: 14%;">
            ...
            <div class="right">
              ...
              <div class="count"><?php echo $incallhr;?></div>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count" style="width: 14%;">
            ...
            <div class="right">
              ...
              <div class="count"><?php echo $outcallhr;?></div>
              <span class="count_bottom"> Today</span>
            </div>
          </div>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count" style="width: 14%;">
            ...
            <div class="right">
              <span class="count_top"><i class="fa fa-clock-o"></i> Inbound Call</span>
              <div class="count"><?php echo $incallwk;?></div>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count" style="width: 14%;">
            ...
            <div class="right">
              <span class="count_top"><i class="fa fa-clock-o"></i> Outbound Call</span>
              <div class="count"><?php echo $outcallwk;?></div>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count" style="width: 14%;">
            ...
            <div class="right">
              <span class="count_top"><i class="fa fa-clock-o"></i> Inbound Call</span>
              <div class="count"><?php echo $incallmonth;?></div>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count" style="width: 14%;">
            ...
            <div class="right">
              <span class="count_top"><i class="fa fa-clock-o"></i> Outbound Call</span>
              <div class="count"><?php echo $outcallmonth;?></div>
              <span class="count_bottom"><i class="green"></i> This Month</span>
            </div>
          </div>

	...
	<style type="text/css">
	   ...
	   $(document).ready(function(){
			...
			$('#selectroute').change(function(){
				if($('#selectroute').val() == 'EXTENSION') {
					$('#divtext').show(); 
					$('#divctype').show();
					$('#divgrp').hide();
				} else if ($('#selectroute').val() == 'GROUP'){
					$('#divgrp').show(); 
					$('#divtext').hide(); 
					$('#divctype').hide();
				} 
			...
			$("#txtdid").bind("change paste", function() {
			   //alert($(this).val()); 
			   var name = $(this).val();
                    $.post('<?php echo base_url(); ?>admin/inbound/chk_did', {usr_name: name}, function(d) {
                        if (d == 1)
                        {
            ...
            <div class="col-md-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form novalidate="" name="frmdid" id="frmdid" class="form-horizontal form-label-left" action="<?php echo base_url("/admin/permissionname/savepermissionname"); ?>" method="post">

                   
                    <span class="section"> Permissions Name </span>

                    <div class="item form-group">
                      <label for="txtdid" class="control-label col-md-3 col-sm-3 col-xs-12">Permission Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Please enter Permissions Name" 
					  ...
					  <span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<select class="form-control" id="selectdis"  name="module">
											...
											<option value="<?php echo $module[$i]->module_id; ?>"><?php echo $module[$i]->modulename; ?></option>												
											<?php } ?>
											</select>
					</div>
					</div>					

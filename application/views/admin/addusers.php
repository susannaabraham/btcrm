        ...
        <div class="">
          ...
          <div class="page-title">
            <div class="title_left">
							<?php	$sql1 ="SELECT * from projects where id='".$id."' ";
									$query1=$this->db->query($sql1); 
									$res1=$query1->result();
									$users=$res1[0]->users;
									$myArray = explode(',', $users); ?>
              <h3>
                 <?php echo $res1[0]->name;?>
                </h3>
            </div>
            ...
            <div class="col-md-12">
              <div class="x_panel">
				...
				<?php if($message){
                  ...
                  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/projects/saveusers");?>"  id="AddForm" name="AddForm">

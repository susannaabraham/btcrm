			...
			<div class="col-md-12">
				<div class="x_panel">
					...
					<?php if($message){
						...
						<form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/expense/editexpense");?>"  id="AddForm" name="AddForm">
							<input type="hidden" value="<?php echo $expense[0]->expense_id; ?>" name="expense_id" />
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
							<select class="form-control sel" id="project" name="project" placeholder="Select Project">
								<?php for($i=0;$i<count($projects);$i++){?>
									<option value="<?php echo $projects[$i]->id?>"  <?php if($expense[0]->project_id==$projects[$i]->id) { echo "selected"; } ?>><?php echo $projects[$i]->name?></option>
								<?php } ?>
							</select>
                      </div>
                    </div>
					...
					<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
							<textarea name="discription" placeholder="Description" class="form-control col-md-7 col-xs-12"><?php echo $expense[0]->discription; ?></textarea>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
							<select class="form-control sel" id="project" name="users" placeholder="Select Project">
								<?php for($i=0;$i<count($users);$i++){?>
									<option value="<?php echo $users[$i]->uname?>" <?php if($expense[0]->posted_by==$users[$i]->uname) { echo "selected"; } ?>><?php echo $users[$i]->uname?></option>
								<?php } ?>
							</select>
                      </div>
                    </div>

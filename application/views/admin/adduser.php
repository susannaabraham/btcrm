            ...
            <div class="col-md-12">
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <form novalidate="" name="frmcallgrp" id="frmcallgrp" class="form-horizontal form-label-left" action="<?php echo base_url("/admin/user/savenewuser"); ?>" method="post">

                    <span class="section">User Detail</span>

                    <div class="item form-group">
                      <label for="txtusername" class="control-label col-md-3 col-sm-3 col-xs-12">User Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Enter User Name" 
						name="txtusername" class="form-control col-md-7 col-xs-12" id="txtusername">
                      </div>
                    </div>
					
					<div class="item form-group">
                      <label for="txtpwd" class="control-label col-md-3 col-sm-3 col-xs-12">Password <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="password" required="required" placeholder="Enter Password" 
						name="txtpwd" class="form-control col-md-7 col-xs-12" id="txtpwd">
                      </div>
                    </div>
					
					<div class="item form-group" id="divgrp">
                      <label for="selectmode" class="control-label col-md-3 col-sm-3 col-xs-12">Select Mode <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                       <select class="form-control required" id="selectmode" name="selectmode">
							<option value="">-Select Mode-</option>
							<?php for($i=0;$i<count($mode);$i++){ ?>
							<option value="<?php echo $mode[$i]->groupid?>"><?php echo $mode[$i]->groupname?></option>
							<?php } ?>
						</select>
                      </div>
                    </div>

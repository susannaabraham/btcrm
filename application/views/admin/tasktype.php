    	...
    	function deletetasktype(id)
			{
				...
				if(confirm("Are you sure you want to delete?")) 
				{
					...
					{				
						type: "POST",
						url: '<?php echo base_url("/admin/tasktype/deletetasktype")?>',
						data: {'id':id},
						dataType: 'json',
						success: function(d)
						{	
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="clearfix"></div>
			 <form id="ShowForm" name="RptForm" class="form-horizontal"  role="form" action="<?php echo base_url("/admin/tasktype"); ?>?<?php echo http_build_query($_GET, '', "&");?>">							
						<fieldset>
							<div class="row">
							<div class="col-lg-4">
									<div class="form-group">
											...
											?>
											<input class="form-inline form-control" id="name" name="name" placeholder="Task Type Name" type="text" value="<?php echo $name; ?>">
								...
								<div class="col-lg-2">
										<input id="btnSearch" class="btn btn-primary searchlist" name="search" type="submit" value="Search"/>
															  ...
															  <div style="text-align:right"><a href="<?php echo base_url(); ?>admin/tasktype/addtasktype" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Task Type</a></div>
						...
						<div class="x_content">
						  <table class="table table-striped responsive-utilities jambo_table bulk_action">
							...
							<TR id="dat_<?php echo $results[$i]->id; ?>" role="row" class="odd">
								...
								<a class="btn btn-default " href="<?php echo base_url('admin/tasktype/edit')."?keyword=".$results[$i]->id; ?>"><i class="fa fa-edit"></i></a>
								<!-----a class="btn btn-default " href="javascript:void(0);" onClick="deletetasktype('<?php echo $results[$i]->id; ?>')"><i class="fa fa-remove"></i></a----->
								</TD>
							</TR>
							 <?php
								}

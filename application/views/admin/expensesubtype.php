...
<head>
  ...
  <!--[if lt IE 9]>
	   ...
	   $(document).ready(function(){
    	...
    	function deleteexpensesubtype(id)
			{
				//alert(did);
				if(confirm("Are you sure you want to delete?")) 
				{
					...
					{				
						type: "POST",
						url: '<?php echo base_url("/admin/expensesubtype/deleteexpensesubtype")?>',
						data: {'exp_subid':id},
						dataType: 'json',
						success: function(d)
						{	
...
<body class="nav-md">
  ...
  <div class="container body">
						...
						<fieldset>
							...
							<div class="col-lg-4">
									<div class="form-group">
											...
											?>
											<input class="form-inline form-control" id="name" name="name" placeholder="Expense Sub Type Name" type="text" value="<?php echo $name; ?>">
	...
	<div style="text-align:right"><a href="<?php echo base_url(); ?>admin/expensesubtype/addexpensesubtype" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Expense Sub Type</a></div>
						  ...
						  <table class="table table-striped responsive-utilities jambo_table bulk_action">
							...
							<tbody>
							  <?php
								...
								if(isset($results[0]->exp_subid))
						        {
								for($i=0;$i<count($results);$i++){ ?>
							<TR id="dat_<?php echo $results[$i]->exp_subid; ?>" role="row" class="odd">
								<TD><?php echo $results[$i]->exp_subname; ?></TD>

								
								<TD style="text-align: right;" >
								<a class="btn btn-default " href="<?php echo base_url('admin/expensesubtype/edit')."?keyword=".$results[$i]->exp_subid; ?>"><i class="fa fa-edit"></i></a>
								<a class="btn btn-default " href="javascript:void(0);" onClick="deleteexpensesubtype('<?php echo $results[$i]->exp_subid; ?>')"><i class="fa fa-remove"></i></a>
								</TD>
							</TR>
							 <?php
								}

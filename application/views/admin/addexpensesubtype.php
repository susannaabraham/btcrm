            ...
            <div class="col-md-12">
              <div class="x_panel">
				...
				<?php if($message){
                  ...
                  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url("/admin/expensesubtype/saveexpensesubtype");?>"  id="AddForm" name="AddForm">



                    <div class="item form-group">
                      <label for="name" class="control-label col-md-3 col-sm-3 col-xs-12">Expense Type Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Expense Type Name" name="exp_subname"   class="form-control col-md-7 col-xs-12" >
                      </div>
                    </div>

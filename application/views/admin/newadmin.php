...
<head>
  ...
  <!--[if lt IE 9]>
	...
	$(document).ready(function(){ 
    $("#call_group").on('change keyup mouseup',function(){
            ...
            <div class="col-md-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form novalidate="" name="frmdid" id="frmdid" class="form-horizontal form-label-left" action="<?php echo base_url("/admin/admin/saveadmin"); ?>" method="post">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Please enter Group Name" 
					...
					<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="password" required="required" placeholder="Please enter Group Name" 
					...
					<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" placeholder="Enter Email ID" name="email" class="form-control col-md-7 col-xs-12" id="email">
                      </div>
                    </div>
					 <div class="item form-group">
					  ...
					  <span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<select class="form-control" id="selectdis"  name="mode">
											...
											<option value="<?php echo $ctype[$i]->groupid; ?>"><?php echo $ctype[$i]->groupname; ?></option>												
											<?php } ?>
											</select>
					</div>
					</div>
					...
					<select class="form-control" id="dashboard" name="dashboard">
											...
											<option value="/admin/admin/addadmin" >Manage Users </option>
											<option value="/admin/permission/addpermission" >Manage Permission Group </option>
											<option value="/admin/cdr/detailed_inbound" >Inbound Call Report </option>
											<option value="/admin/cdr/outbound" >Outbound Call Report </option>
											<option value="/admin/agents/report" >AGENT PERFORMANCE REPORT</option>
											<option value="/admin/cdr/msdcall" >Missed Calls</option>
											<option value="/admin/call_volume" >Call volume statistics</option>
											<option value="/admin/call_report/inbound" >Call Reports</option>
											<option value="/admin/campain/addcampain" >Campaign</option>
											<option value="/admin/campainReport/report" >Campaign Report</option>
											<option value="/admin/conference" >Conference</option>
											<option value="/admin/voicealert/group" >EMERGENCY ALERT </option>
											<option value="/admin/voicealert/listalerts" >EMERGENCY ALERT LIST </option>
											<option value="/admin/data/data_cdr" > MEDICAL TRANSCRIPTION</option>
											<option value="/admin/mailbox/data_cdr?selectdis=6" >Customer-Feedback</option>
											<option value="/admin/mailbox/data_cdr?selectdis=5" >Employee-Feedback</option>

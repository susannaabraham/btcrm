  ...
  <!--[if lt IE 9]>
	...
	function deleteAdmin(id)
	{
		...
		if(confirm("Are you sure you want to delete?")) 
		{
			...
			{				
				type: "POST",
				url: '<?php echo base_url("/admin/permission/deletepermission")?>',
				data: {'groupid':id},
				dataType: 'json',
				success: function(d)
				{	
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
               <!-- <div class="x_title">
                ...
                <div class="x_content">
                  <p style="text-align:right;"><a href="<?php echo base_url("admin/permission/newpermission"); ?>"  class="btn btn-primary"><i class="fa fa-plus"></i> Add New Permissions</a></p>
                  <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    ...
                    <tbody>  
						...
						?>
						<TR id="dat_<?php echo $cgrp1[$i]->permissions; ?>" role="row" class="odd">
							<TD><?php echo $cgrp1[$i]->groupname; ?></TD>
							
							<TD style="text-align:right">
								<a class="btn btn-default " href="<?php echo base_url('/admin/permission/editPermission')."?keyword=".$cgrp1[$i]->groupid."&type=1"; ?>"><i class="fa fa-edit"></i></a>
								<a class="btn btn-default " href="javascript:void(0);" onClick="deleteAdmin('<?php echo $cgrp1[$i]->groupid; ?>');"><i class="fa fa-remove"></i></a>
							</TD>
						</TR>
						<?php
							}
